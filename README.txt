...
To run the script run Interface.py ($python3 Interface.py) and the website should now be up on your localhost
...
-Create and upload problems in C, C++ or Python that users can submit solutions to. Attach your solution and specify inputs and the website will automatically generate input/output pairs. The time limit for the submission can also be specified as well as whether valgrind should check for memory errors
